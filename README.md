...
1. Create a file called `my-repo.yaml` in the `./content/` directory with the following contents:
   ```markdown
   ---
...
| `feature`        | (optional, only valid when `type == 'project'`)<br>An integer value. Used to add this project to the "Featured Projects" list on the name page. The list is in descending order based on the value of these `feature` keys.                                                                                                                                                                                                                                                                                                        |
